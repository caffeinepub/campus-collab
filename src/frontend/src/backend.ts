...
export class Backend implements backendInterface {
    ...
    async createProject(arg0: string, arg1: string, arg2: Array<string>, arg3: Array<string>, arg4: string | null, arg5: string | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createProject(arg0, arg1, arg2, arg3, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n3(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getConversationPreview(): Promise<Array<ConversationPreview>> {
        if (this.processError) {
            try {
                const result = await this.actor.getConversationPreview();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMessageThread(arg0: Principal): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async getProjectsBySkill(arg0: string): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectsBySkill(arg0);
                return from_candid_vec_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markThreadRead(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: Principal, arg1: string, arg2: bigint | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessage(arg0, arg1, to_candid_opt_n21(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Project]): Project | null {
    return value.length === 0 ? null : from_candid_Project_n9(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        figmaUrl: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.figmaUrl)),
        title: value.title,
        skillsOffered: value.skillsOffered,
        owner: value.owner,
        description: value.description,
        githubUrl: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.githubUrl)),
        timestamp: value.timestamp,
        skillsNeeded: value.skillsNeeded
    };
}
function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        from: value.from,
        read: value.read,
        projectId: record_opt_to_undefined(from_candid_opt_n17(_uploadFile, _downloadFile, value.projectId)),
        timestamp: value.timestamp
    };
}
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        portfolioUrl: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.portfolioUrl)),
        skills: value.skills
    };
}
...
function from_candid_vec_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_UserProfile>): Array<UserProfile> {
    return value.map((x)=>from_candid_UserProfile_n5(_uploadFile, _downloadFile, x));
}
...
function to_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        available: value.available,
        portfolioUrl: value.portfolioUrl ? candid_some(value.portfolioUrl) : candid_none(),
        skills: value.skills
    };
}
